...
async def get_available_characters():
    ...
    filtered = [c for c in all_chars if STORE_RARITY_ENABLED.get(c.get('rarity', ''), True)]
    return filtered if filtered else all_chars
